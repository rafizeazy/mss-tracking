    ...
    <div class="mb-6 flex flex-col md:flex-row md:items-center justify-between gap-3">
        ...
        <div class="relative w-full md:w-72">
            ...
            <input
                ...
                class="w-full rounded-[0.3rem] border border-[#dee2e6] bg-white py-2 pl-9 pr-4 text-sm text-[#4c4c5c] shadow-sm focus:border-[#70bb63] focus:outline-none focus:ring-1 focus:ring-[#70bb63] dark:border-[#37394d] dark:bg-[#1e1f27] dark:text-[#aab8c5]"
            >
        </div>
    </div>
                        ...
                        @forelse ($customers as $customer)
                            <tr class="flex flex-col md:table-row border-b border-[#e7e9eb] md:border-none dark:border-[#37394d] p-5 md:p-0 gap-3 md:gap-0 hover:bg-[#f8f9fa] dark:hover:bg-white/5 transition-colors">
                                ...
                                <td class="flex justify-between items-center md:table-cell md:px-6 md:py-4 whitespace-nowrap border-b border-dashed border-[#e7e9eb] md:border-none dark:border-[#37394d] pb-3 md:pb-0">
                                    ...
                                    <span class="font-medium md:font-normal text-[#313a46] dark:text-white md:text-inherit">{{ $customer->updated_at->translatedFormat('d M Y, H:i') }}</span>
                                </td>
                                ...
                                <td class="md:px-6 md:py-4 md:text-center mt-3 md:mt-0 block md:table-cell">
                                    <a href="{{ route('finance.tracking.show', $customer->id) }}" wire:navigate class="w-full md:w-auto inline-flex justify-center items-center btn-boron btn-boron-outline-primary !px-4 !py-2.5 md:!px-3 md:!py-1 text-sm md:text-xs rounded-lg md:rounded">
