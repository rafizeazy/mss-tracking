                            ...
                            <tr class="hover:bg-[#f8f9fa] dark:hover:bg-white/5 transition-colors">
                                ...
                                <td class="px-6 py-4 text-center">
                                    <div class="flex items-center justify-center gap-1.5 flex-wrap">
                                        ...
                                        @if($cust->spk) <a href="{{ route('marketing.spk', $cust->id) }}" target="_blank" class="btn-boron btn-boron-outline-primary !px-2 !py-1 text-[11px]" title="Lihat SPK"><i class="ti ti-file-description"></i> SPK</a> @endif
                                        @if($cust->baa) <a href="{{ route('noc.baa', $cust->id) }}" target="_blank" class="btn-boron btn-boron-outline-success !px-2 !py-1 text-[11px] !text-[#70bb63] !border-[#70bb63]" title="Lihat BAA"><i class="ti ti-file-certificate"></i> BAA</a> @endif
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-3 mt-4 md:mt-0">
                            ...
                            <div class="bg-[#f8f9fa] dark:bg-white/5 p-3 rounded text-xs space-y-1 border border-[#e7e9eb] dark:border-[#37394d]">
                                <p><span class="text-[#8a969c] w-20 inline-block">Nama:</span> <span class="font-medium text-[#313a46] dark:text-white">{{ $selectedCustomer->finance_name ?? '-' }}</span></p>
                                <p><span class="text-[#8a969c] w-20 inline-block">Kontak:</span> <span class="font-medium text-[#313a46] dark:text-white">{{ $selectedCustomer->finance_phone ?? '-' }}</span></p>
                                <p><span class="text-[#8a969c] w-20 inline-block align-top">Alamat Tagihan:</span> <span class="font-medium text-[#313a46] dark:text-white inline-block w-[calc(100%-5rem)]">{{ $selectedCustomer->billing_address ?? '-' }}</span></p>
                            </div>

                            <p class="text-xs font-semibold text-[#8a969c] uppercase mb-1 mt-3">PIC Teknis / Lapangan</p>
                            <div class="bg-[#f8f9fa] dark:bg-white/5 p-3 rounded text-xs space-y-1 border border-[#e7e9eb] dark:border-[#37394d]">
