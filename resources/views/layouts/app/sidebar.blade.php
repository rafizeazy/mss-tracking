                ...
                <header class="boron-topbar sticky top-0 z-30 flex items-center gap-4 px-4 sm:px-6">
                    ...
                    <div class="hidden flex-1 sm:block sm:max-w-xs" x-data>
                        <div class="relative">
                            ...
                            <input type="text" 
                                ...
                                class="w-full rounded-[0.3rem] border border-zinc-800 bg-transparent py-2 pl-9 pr-4 text-sm placeholder:text-zinc-500 focus:outline-none focus:ring-2 focus:ring-[#669776]/30 dark:border-[#37394d] dark:text-white"
                            >
                        </div>
                    </div>
                    ...
                    <div class="flex flex-1 items-center justify-end gap-2">
                        ...
                        <div class="relative ml-1" x-data="{ open: false }">
                            <button @click="open = !open" class="flex items-center gap-2 rounded-[0.3rem] border border-zinc-800 bg-white px-3 py-1.5 text-sm transition-all hover:bg-zinc-100 dark:border-[#37394d] dark:bg-[#1e1f27] dark:hover:bg-[#252630]" data-test="sidebar-menu-button">
                            ...
                            <div x-show="open" @click.away="open = false"
                                ...
                                x-cloak
                                class="absolute right-0 mt-2 w-52 origin-top-right rounded-[0.3rem] border border-zinc-800 bg-white py-1 shadow-lg dark:border-[#37394d] dark:bg-[#1e1f27]"
