                        ...
                        @if (Route::has('login'))
                            @auth
                                <a href="{{ route('dashboard') }}" class="inline-flex items-center justify-center px-5 py-2.5 text-sm font-semibold text-white bg-brand-blue rounded-lg shadow-md hover:bg-[#164a6e] hover:shadow-lg transition-all">
                                    Masuk Dashboard <i class="ti ti-arrow-right ml-2 text-lg"></i>
                                </a>
                            @else
                                ...
                                {{-- @if (Route::has('register'))
                                    <a href="{{ route('register') }}" class="inline-flex items-center justify-center px-5 py-2.5 text-sm font-semibold text-white bg-brand-green rounded-lg shadow-md hover:bg-[#175232] hover:shadow-lg transition-all hidden sm:inline-flex">
                                        Registrasi Baru
                                    </a>
                                @endif --}}
                            @endauth
    ...
    <section id="beranda" class="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-white">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4">
                @auth
                    <a href="{{ route('dashboard') }}" class="px-8 py-3.5 text-base font-bold text-white bg-brand-blue rounded-xl shadow-lg shadow-brand-blue/30 hover:bg-[#164a6e] hover:shadow-xl hover:-translate-y-0.5 transition-all">
                        Buka Dashboard Panel
                    </a>
                @else
                    {{-- <a href="{{ route('register') ?? '#' }}" class="px-8 py-3.5 text-base font-bold text-white bg-brand-blue rounded-xl shadow-lg shadow-brand-blue/30 hover:bg-[#164a6e] hover:shadow-xl hover:-translate-y-0.5 transition-all">
                        Daftar Berlangganan
                    </a> --}}
                @endauth
                <a href="#keunggulan" class="px-8 py-3.5 text-base font-bold text-brand-dark bg-white border-2 border-gray-200 rounded-xl hover:border-brand-blue hover:text-brand-blue transition-colors">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-xl hover:border-brand-lightBlue/30 transition-all group">
                    ...
                    <p class="text-gray-500 text-sm leading-relaxed mb-6">Nikmati rasio kecepatan Upload dan Download yang sama persis. Bandwidth 100% murni milik Anda tanpa dibagi dengan pengguna lain, ideal untuk kebutuhan server dan sinkronisasi data.</p>
                    <ul class="space-y-2 text-sm font-medium text-brand-dark mb-6">
                        ...
                        <li class="flex items-center gap-2"><i class="ti ti-check text-brand-green text-lg"></i> Gratis IP Public Static</li>
                    </ul>
                </div>

                <!-- Card 2: Keandalan & SLA -->
                <div class="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-xl hover:border-brand-lightBlue/30 transition-all group relative overflow-hidden">
                    ...
                    <p class="text-gray-500 text-sm leading-relaxed mb-6">Kami memahami bahwa *downtime* adalah kerugian finansial bagi perusahaan Anda. Kami memberikan garansi *uptime* jaringan yang dituangkan langsung ke dalam dokumen kontrak resmi.</p>
                    <ul class="space-y-2 text-sm font-medium text-brand-dark mb-6">
                        ...
                        <li class="flex items-center gap-2"><i class="ti ti-check text-brand-green text-lg"></i> Jalur Koneksi Stabil & Minim Latency</li>
                    </ul>
                </div>

                <!-- Card 3: Support & Monitoring -->
                <div class="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-xl hover:border-brand-lightBlue/30 transition-all group">
                    ...
                    <p class="text-gray-500 text-sm leading-relaxed mb-6">Tim Network Operation Center (NOC) kami bekerja di belakang layar untuk memantau trafik jaringan Anda secara proaktif selama 24 jam sehari, 7 hari seminggu.</p>
                    <ul class="space-y-2 text-sm font-medium text-brand-dark mb-6">
                        <li class="flex items-center gap-2"><i class="ti ti-check text-brand-green text-lg"></i> Respon Cepat (Fast Response)</li>
                        <li class="flex items-center gap-2"><i class="ti ti-check text-brand-green text-lg"></i> Pemantauan Trafik Real-time</li>
